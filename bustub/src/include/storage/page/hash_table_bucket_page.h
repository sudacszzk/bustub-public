...
//(key_0, value_0) and (key_0, value_1) can exist in the same hash table, but not (key_0, value_0) and (key_0, value_0)
  /**
...
//#define MappingType std::pair<KeyType, ValueType>
 ...
 private:
  ...
  char occupied_[(BUCKET_ARRAY_SIZE - 1) / 8 + 1];//  /8是因为每个char有8位
